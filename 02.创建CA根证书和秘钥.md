...
注意：如果没有特殊指明，本文档的所有操作**均在 linker-k8s-01 节点上执行**。  用户: linker
...
for node_ip in ${NODE_IPS[@]}
  do
    ...
    ssh root@${node_ip} "rm -rf /etc/kubernetes/cert/ca-config.json"
    ssh root@${node_ip} "rm -rf /etc/kubernetes/cert/ca*.pem"
